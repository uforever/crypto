...
fn main() -> Result<()> {
    ...
    let bytes5 = Bytes::new(string_data.as_bytes());
    let bytes6 = Bytes::new(str_data.as_ref());
    ...
    // base64
    println!("---- ---- Base64 ---- ----");
    let from_base64_input = Bytes::new(b"SGVsbG8=".as_ref());
